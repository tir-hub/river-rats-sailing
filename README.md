...
~/Documents/Data/RiverRats/<year>/
  Session-1/ .. Session-7/
    ...
    Registration_details.pdf  — downloaded by grab-session-data.pl
...
`Registration_details.pdf` directly from the website.  Use `-d` / `-dd` / `-ddd`
...
6. Download the **Registration Details** PDF — save as `Registration_details.pdf`.
